    ...
    <div id="wd-lab1">
      ...
      <div id="wd-p-tag">
        ...
        <p id="wd-p-1">
          ...
          vertical white spaces and rend er all the text as one single set of
      ...
      <div id="wd-lists">
        ...
        My favortie recipe: rompertof carnitas
        <ol id="wd-your-favorite-recipe">
          <li>Soak the clay pot</li>
          <li>Dry and season the pork shoulder</li>
          <li>Put the pork in the rompertof</li>
          <li>Add salsa, marinade, green chiles, lemon and lime juice</li>
          <li>Cook at 325 in the oven for 5 hours</li>
        </ol>
