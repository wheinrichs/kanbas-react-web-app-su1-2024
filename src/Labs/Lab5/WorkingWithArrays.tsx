...
export default function WorkingWithArrays() {
  ...
  return (
    <div id="wd-working-with-arrays">
      ...
      <input type="checkbox" className="form-check-input" checked={todo.completed} onChange={(e) => setTodo({ ...todo, completed: e.target.checked })}/>
      <hr/>
      ...
      <input value={todo.description} className="form-control w-50" onChange={(e) => setTodo({ ...todo, description: e.target.value })}/>
      <hr/>
    </div>
  );
}
